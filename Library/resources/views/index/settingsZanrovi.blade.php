                    ...
                    <table class="overflow-hidden shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                        <thead class="bg-[#EFF3F6]">
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <th id="default_checked" class="px-4 py-4 leading-4 tracking-wider text-left">Naziv zanra
                                <a 
                                ...
                                <th id="if_checked" class="none px-4 py-4 text-sm leading-4 tracking-wider text-left">
                                    <form id="zanr_delete_all" action="" method="POST">
                                        @csrf
                                        @method("get")
                                ...
                                <th style="color: rgb(58, 26, 152);font-weight:600;font-style:italic;" id="if_one_checked" class="none px-4 py-4 text-sm leading-4 tracking-wider text-left">
                                    <form id="zanr_delete" method="POST" action="">
                                        @csrf
                                        @method('DELETE')
                                        <button style="color: rgb(58, 26, 152);font-weight:600;font-style:italic;" type="submit" name="submit">
                                            Izbrišite zanr
                        ...
                        <tbody class="bg-white">
                            ...
                            @foreach ($genres as $genre)
                                ...
                                <td class="px-4 py-4 whitespace-no-wrap">
                                    <label class="inline-flex items-center">
                                        <input id="table_checkboxes" type="checkbox" class="form-checkbox" data-zanr-id="{{$genre->id}}">
                                    </label>
                                </td>
        ...
        checkboxes.forEach(e => {
            e.addEventListener("change",()=>{
                ...
                if(nmb_of_checked == 1){
                    ...
                    var zanr_edit = document.getElementById("zanr_edit");
                    var zanr_delete = document.getElementById("zanr_delete");
                    
                    var id = e.dataset.zanrId;
                   
                   
                    
                    zanr_edit.setAttribute("href","http://127.0.0.1:8000/genre/"+id+"/edit");
                    zanr_delete.setAttribute("action","http://127.0.0.1:8000/genre/"+id);
                    ...
                    var zanr_delete_more = document.getElementById("zanr_delete_all");
                    var checked = document.querySelectorAll("#table_checkboxes:checked");
                    var ids="";
                    checked.forEach(checked =>{
                        ids += "-"+checked.dataset.zanrId;
                    })
                    
                    ids = ids.slice(1);
                    zanr_delete_more.setAttribute("action","http://127.0.0.1:8000/deletezanr/"+ids)
                    default_checked.forEach(l =>{
                        l.classList.add("none");
                    });
                    if_one_checked.forEach(o =>{
