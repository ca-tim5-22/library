...
<head>
    ...
    <!-- Title -->
    <title>New publisher | Specification | Library - ICT Cortex student project</title>
    ...
    <main class="flex flex-row small:hidden">
        ...
        <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form class="text-gray-700 " method="POST" action="{{route('publisher.store');}}">
                @csrf   
                @method('POST')
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="name" id="nazivIzdavac" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsNazivIzdavac()"/>
                    ...
                    <div class="absolute bottom-0 w-full">
                        <div class="flex flex-row">
                            <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                                ...
                                <button  type="submit" name="submit" id="sacuvajIzdavac"
