...
<head>
    ...
    <!-- Title -->
    <title>New book bind | Specification | Library - ICT Cortex student project</title>
    ...
    <main class="flex flex-row small:hidden">
        ...
        <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
                        ...
                        <div>
                            <nav class="w-full rounded">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a href="{{route('binding.index');}}" class="text-[#2196f3] hover:text-blue-600">
                                            Povezi
                                        </a>
                                    </li>
                                    <li>
            ...
            <div class="scroll height-content section-content">
                <form class="text-gray-700" action="{{route('binding.store');}}" method="post">
                    @csrf
                    @method('post')
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="name" id="nazivPovez" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsNazivPovez()"/>
