    ...
    {{$book->content}}
                                                        ...
                                                        onclick="clearErrorsKategorija()">
                                                            ...
                                                            <template x-for="(option,index) in selected"
                                                                :key="options[option].value">
                                                                    ...
                                                                    <div class="flex items-center justify-center px-[6px] py-[2px] m-1 text-blue-800 bg-blue-200 rounded-[10px] ">
                    ...
                    <div class="mt-[20px]">
                        ...
                        <select
                            ...
                            <option value="{{$book->publisher}}" selected>{{$book->publisher->name}}</option>
                    ...
                    <div class="mt-[20px]">
                        ...
                        <select
                            ...
                            <option value="{{$book->release_date}}" selected>{{$book->release_date}}.godina</option>
                    ...
                    <div class="mt-[20px]">
                        ...
                        <input type="text" name="total" id="knjigaKolicina" value="{{$book->total}}"
                ...
                <div class="flex flex-row ml-[30px]">
                    <div class="w-[50%] mb-[150px]">
                        <div class="mt-[20px]">
                            ...
                            <input type="text" name="number_of_pages" id="brStrana" value="{{$book->number_of_pages}}"
                                class="flex w-[45%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]"
                        ...
                        <div class="mt-[20px]">
                            ...
                            <select
                                ...
                                <option value="{{$book->alphabet}}" selected>{{$book->alphabet->name}}</option>
                        ...
                        <div class="mt-[20px]">
                            ...
                            <select
                                ...
                                <option value="{{$book->binding}}" selected>{{$book->binding->name}}</option>
