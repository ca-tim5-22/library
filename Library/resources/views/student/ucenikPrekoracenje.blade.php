            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <p class="inline cursor-pointer text-[25px] py-[10px] pl-[30px] border-l-[1px] border-gray-300 dotsUcenikKnjigePrekoracenje hover:text-[#606FC7]">
                        ...
                        <table class="overflow-hidden shadow-lg rounded-xl w-full border-[1px] border-[#e4dfdf]" id="myTable">
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                        ...
                                        <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$overdue->student}}</td>
                                        ...
                                        <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                            ...
                                            <div
                                                ...
                                                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{route('book.show',$overdue->book_id);}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <a href="{{route('book.edit',$overdue->book_id);}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <a href="{{route('rent.new',$overdue->book_id);}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <a href="{{route('reservation.new',$overdue->book_id);}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <a href="{{route('rent.returnbook',$overdue->book_id);}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <a href="{{route("abandon_index",$overdue->book_id)}}" tabindex="0"
                                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                            role="menuitem">
                                                        ...
                                                        <form action="{{route('book.destroy',$overdue->book_id);}}" method="POST">
                                                            @csrf
                                                            @method("DELETE")
