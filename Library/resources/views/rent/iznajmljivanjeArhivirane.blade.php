            ...
            <div class="flex flex-row height-iznajmljivanje scroll">
                <div class="w-[80%]">
                    <div class="border-b-[1px] border-[#e4dfdf] py-4  border-gray-300 pl-[30px]">
                        ...
                        <a href="{{route('reservation.archive',$book);}}" class="inline ml-[70px] active-book-nav hover:text-blue-800">
                        ...
                        <table class="overflow-hidden shadow-lg rounded-xl w-full border-[1px] border-[#e4dfdf] rezervacije" id="myTable">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$reservation->datum_isteka}}</td>
                                    <td class="flex flex-row items-center px-4 py-3">
                                        @foreach ($users as $user)
                                        
                                        @if($user->id==$reservation->foruser_id)
