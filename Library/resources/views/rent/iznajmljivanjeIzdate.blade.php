                        ...
                        <table class="overflow-hidden shadow-lg rounded-xl w-full border-[1px] border-[#e4dfdf]" id="myTable">
                            <thead class="bg-[#EFF3F6]">
                                ...
                                <tr class="border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <th id="default_checked" class="px-4 py-4 text-sm leading-4 tracking-wider text-left">Knjigu izdao</th>
                                ...
                                @if ($i < $count)
                                  <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    <td class="px-4 py-3 whitespace-no-wrap">
                                        <label class="inline-flex items-center">
                                            <input value="{{$rent->id}}" name="rent_id[]" type="checkbox" id="table_checkboxes" class="form-checkbox" data-rent-id="{{$rent->id}}">
                                        </label>
                                    </td>
